...
export async function executeApprovalDecision({record,decision,user,db,github,heygen,youtube}){
...
// actor string.
export async function applyApprovalDecision({record,decision,actor,db,github,heygen,youtube}){
  const result=await executeApprovalDecision({record,decision,user:{email:actor},db,github,heygen,youtube});
...
export async function onRequestPost(context){
  try{
    ...
    const result=await applyApprovalDecision({record,decision:body.decision,actor:user.email,db:context.env.CONTROL_DB,github,heygen,youtube});
